...
//////////
function draw(ballPosition,BALLRADIUS,block,block2){
    draw_bg();
    drawSpaces(block);
    drawSpaces2(block2);
    c.fillStyle="blue";
...
/////////
function update(block,block2,ballPosition,vx,vy){
    if(vx==0){
    onRed=true;
    }
...
function checkGameStatus(block,block2,xnew,ynew){
...
function main(){ 
    if(playing==true){
        requestAnimationFrame(main);
            ...
            var [xnew,ynew] = update(block,block2,lastLocation,vx,vy);
            console.log(xnew);
            lastLocation.x=xnew;
            lastLocation.y=ynew;
            console.log(lastLocation);
            draw(lastLocation,BALLRADIUS,block,block2);
            playing=checkGameStatus(block,block2,xnew,ynew);
        }
